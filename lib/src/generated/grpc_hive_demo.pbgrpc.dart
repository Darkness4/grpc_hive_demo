...
import 'grpc_hive_demo.pb.dart' as $0;
export 'grpc_hive_demo.pb.dart';

class GrpcHiveDemoClient extends $grpc.Client {
  static final _$getUser = $grpc.ClientMethod<$0.Username, $0.User>(
      '/grpchivedemo.GrpcHiveDemo/GetUser',
      ($0.Username value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.User.fromBuffer(value));
  static final _$getAll = $grpc.ClientMethod<$0.Empty, $0.User>(
      '/grpchivedemo.GrpcHiveDemo/GetAll',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.User.fromBuffer(value));

  GrpcHiveDemoClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
...
abstract class GrpcHiveDemoServiceBase extends $grpc.Service {
  $core.String get $name => 'grpchivedemo.GrpcHiveDemo';

  GrpcHiveDemoServiceBase() {
